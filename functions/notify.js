/**
 * Push мастеру: на Android только data. Шторку рисует
 * VoiceFirebaseMessagingService — системный notification-payload
 * часто пропадает за кастомным FCM-сервисом Twilio.
 */
