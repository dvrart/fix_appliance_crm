...
Future<void> openPhotosEditor(
  ...
  final saved = await _openEditor<List<Map<String, dynamic>>>(
    context,
    _PhotosEditorPage(initial: photos),
  );
  if (saved != null) {
          ...
          return Scaffold(
            ...
            appBar: AppBar(
              ...
              leading: IconButton(
                ...
                onPressed: () => DirtyLeaveScope.of(context)?.requestLeave(),
              ),
              actions: [
                TextButton(
                  ...
                  child: Text(
                    'Сохранить'.tr,
                    style: TextStyle(
                      color: dirty ? AppColors.accent : Colors.white54,
        ...
        builder: (context) {
          return Scaffold(
            ...
            appBar: AppBar(
              ...
              actions: [AppBarSaveButton(dirty: _dirty, onPressed: _save)],
            ),
            body: Column(
              children: [
                AnimatedBuilder(
                  ...
                  builder: (context, _) {
                    ...
                    final tint = Color.lerp(_solutionTint, _problemTint, t)!;
...
class _PhotosEditorPage extends StatefulWidget {
  ...
  const _PhotosEditorPage({required this.initial});
        ...
        child: Padding(
          ...
          child: SizedBox(
            ...
            child: ElevatedButton.icon(
              ...
              label: Text('Добавить фотографии'.tr),
