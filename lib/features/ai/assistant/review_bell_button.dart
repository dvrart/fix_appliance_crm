...
import '../../jobs/parts_queue_screen.dart';

enum _InboxTab { calls, jobs }
...
class ReviewBellButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return _ReviewInboxStreams(
      builder: (jobs, pending, processing, lessons, emailOffers, waitingParts) {
...
class ReviewInboxPanelState extends State<ReviewInboxPanel>
  ...
  List<_InboxItem> _items({
    ...
    required List<SmsMessage> emailOffers,
    required List<Job> waitingParts,
  }) {
    final host = widget.hostContext;
            ...
            unawaited(
              _closeInboxThen(() async {
                ...
                await ConversationScreen.open(
                  ...
                  contactName: _ownerName(extracted, from),
  ...
  Widget build(BuildContext context) {
    return _ReviewInboxStreams(
      builder:
          (jobs, pendingAll, processing, lessons, emailOffers, waitingParts) {
                        ...
                        unawaited(
                          _closeInboxThen(() async {
                            await Navigator.of(
                              ...
                              MaterialPageRoute(
                                builder: (_) => const PartsQueueScreen(),
                              ),
                            );
                          }),
                        );
