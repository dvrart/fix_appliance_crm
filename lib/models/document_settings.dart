...
class DocumentSettings {
  ...
  final double invoiceLogoSize;
  final double invoiceQrSize;
  final String invoiceLogoAlign;
  final String invoiceQrAlign;
  ...
  const DocumentSettings({
    ...
    this.invoiceLogoSize = 56,
    this.invoiceQrSize = 52,
    this.invoiceLogoAlign = 'left',
    this.invoiceQrAlign = 'footer_left',
    this.documentPrefix = '',
  ...
  static const invoiceLogoAlignLeft = 'left';
  static const invoiceLogoAlignCenter = 'center';
  static const invoiceLogoAlignRight = 'right';
  static const invoiceQrFooterLeft = 'footer_left';
  static const invoiceQrFooterRight = 'footer_right';
  static const invoiceQrUnderTotals = 'under_totals';
  static const invoiceQrHeaderRight = 'header_right';
  ...
  DocumentSettings copyWith({
    ...
    int? invoiceAccent,
    double? invoiceLogoSize,
    double? invoiceQrSize,
    String? invoiceLogoAlign,
    String? invoiceQrAlign,
    ...
    return DocumentSettings(
      ...
      invoiceLogoSize: invoiceLogoSize ?? this.invoiceLogoSize,
      invoiceQrSize: invoiceQrSize ?? this.invoiceQrSize,
      invoiceLogoAlign: invoiceLogoAlign ?? this.invoiceLogoAlign,
      invoiceQrAlign: invoiceQrAlign ?? this.invoiceQrAlign,
  ...
  static const defaults = DocumentSettings(
    ...
    invoiceLogoSize: 56,
    invoiceQrSize: 52,
    invoiceLogoAlign: invoiceLogoAlignLeft,
    invoiceQrAlign: invoiceQrFooterLeft,
    documentPrefix: '',
    nextInvoiceNumber: 1,
  ...
  factory DocumentSettings.fromMap(Map<String, dynamic>? data) {
    ...
    return DocumentSettings(
      ...
      invoiceLogoSize:
          (map['invoiceLogoSize'] as num?)?.toDouble() ?? defaults.invoiceLogoSize,
      invoiceQrSize:
          (map['invoiceQrSize'] as num?)?.toDouble() ?? defaults.invoiceQrSize,
      invoiceLogoAlign:
          (map['invoiceLogoAlign'] ?? defaults.invoiceLogoAlign).toString(),
      invoiceQrAlign: (map['invoiceQrAlign'] ?? defaults.invoiceQrAlign).toString(),
  ...
  Map<String, dynamic> toMap() {
    return {
      ...
      'invoiceQrSize': invoiceQrSize,
      'invoiceLogoAlign': invoiceLogoAlign,
      'invoiceQrAlign': invoiceQrAlign,
